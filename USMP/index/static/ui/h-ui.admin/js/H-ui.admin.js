...
/*存储-添加*/
function addstorageinfo(title,url,w,h){
	layer_show(title,url,w,h);
}

/*存储-添加*/
function delstorageinfo(title,url,w,h){
	layer_show(title,url,w,h);
}

/*存储-配置刷新*/
function goupdatestoragedb(title,url,w,h){
	layer_show(title,url,w,h);
}

/*NAS-配置刷新*/
function gotoupdatenasdb(title,url,w,h){
	layer_show(title,url,w,h);
}
