    ...
    var initSiderbarMenu = function () {
        ...
        $.ajax({
            ...
            success:function(result){
                for (var i = 0 ;i<result.netapp_nas_list.length ;i++){
                    $('#netapp_nas_list').append("<li> <a>" + result.netapp_nas_list[i] + "</a> </li>");
                } 
                for (var i = 0 ;i<result.hds_storage_list.length ; i++){
                    $('#hds_storage_list').append("<li> <a>" + result.hds_storage_list[i] + "</a> </li>");
                }
                for (var i = 0 ;i<result.xp_storage_list.length ; i ++){
                    $('#xp_storage_list').append("<li> <a>" + result.xp_storage_list[i] + "</a> </li>");
                } 
                for (var i = 0 ;i<result.hus_storage_list.length ; i ++){
                    $('#hus_storage_list').append("<li> <a>" + result.hus_storage_list[i] + "</a> </li>");
                } 
                for (var i = 0 ;i<result.hds_nas_list.length ; i ++){
                    $('#hds_nas_list').append("<li> <a>" + result.hds_nas_list[i] + "</a> </li>");
                } 
                for (var i = 0 ;i<result.pit_pm_list.length ; i ++){
                    $('#pit_pm_list').append("<li> <a>" + result.pit_pm_list[i] + "</a> </li>");
                }              
            }
        })
    } 
